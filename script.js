...
window.attachBlurbsToCharts = function(options){
  var $matchingLi = $('.text-content > ul > li').has('strong:contains("' + options.title + '")');
  ...
  Papa.parse(config.csvURL, {
    ...
    complete: function(results) {
      ...
      var rowNames = rowNames.map(function(name){
        ...
        if ( yyyymmdd ) {
          // console.warn('its a hit', Date.parse(YYYYMMDD[1] + '/' + YYYYMMDD[2] + '/' + YYYYMMDD[3]));
          return Date.parse(
            yyyymmdd[1] + '/' + 
            yyyymmdd[2] + '/' + 
            yyyymmdd[3]
...
var pages = {
  ...
  "trade-balance": {
    ...
    csvURL: 'https://gist.githubusercontent.com/ericpedia/e4da7edc5a87733122e567cfa3da37d7/raw/a630f445d65dcdd130571756809d5088bf1f8d81/cfpa-balance.tsv'
  },
  "trade-technology": {
    container: "#charts.trade-technology",
    csvURL: "https://gist.githubusercontent.com/ericpedia/a50784d4372c0311e6776eeb048b65a5/raw/2a3512f92fe8cdf2790911aaecba2207c062413b/cfpa-technology.tsv",
  ...
  "trade-currency": {
    ...
    csvURL: 'https://gist.githubusercontent.com/ericpedia/1f929eed653cba8be0613849a75f12c3/raw/86465b0e737b9c84180ee1bf2771f24fb07003a2/cfpa-currency.tsv',
    highchartsOptions: {
      yAxis: [
        {
          title: {
  ...
  "trade-global": {
    ...
    csvURL: "https://gist.githubusercontent.com/ericpedia/d6ac55b76654f270b3e1771136a4a358/raw/f83eb12f8e17a202f3460c64eaa8ea896813eee2/cfpa-global.tsv",
...
$.each(pages, function(key, pageOptions) {
  ...
  // console.log("--------------------------", pageOptions.csvURL);
